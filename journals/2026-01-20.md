...
- [[10]]:[[10]] 剛結束為 ((696ee822-d457-4855-85e6-3af675512324)) 整理成 ((696ee84a-e4b6-4721-a7fb-1e71fe844ea6))，據我平時我在 [[Logseq]] 日誌的編輯習慣和格式 [[formatting]] ，添加到 [[Rovo Dev CLI]] 和 [[Antigravity]] 的[[全局規則配置]]如 [[GEMINI.md]]
	...
	- ## 規則體系建立完成
	  ...
	  #拼# 架構真相
	- [TRovo Dev CLIl MER : [[Atlassian11
	- E [[LLM]]: [[Anthropic]] [[Claude Sonnet]] [[4.5]]
	  #EU ID: 'anthropic. claude-sonnet-4-5-20250929-V1:0
	- 這就是為什麼 [ICLAUDE.md]]有關聯性！
	- ### 規則層級體系
	  
	  1桃優先級米 1水文件水水1水用途水1林適用範圍桃1
	  
	  [[1]〕最高
	  [[211 Ф E
	  [[311 *
	  參考 ~/.rovodev/ROVODEV_ RULES.md' [ROvO Dev]〕專用規則1僅Rovo Dev 1
	  ~/CLAUDE.md 1rrclaude]〕通用規則1所有使用claude 的工具！
	  ‘~/.rovodev/ LOGSEQ_FORMATTING_RULES.md° I IILogseq]〕格式化1輸出格式層1
	  | '~/.gemini/GEMINI.md' | [[Gemini]] #/ | [[Antigravity IDE]] |
