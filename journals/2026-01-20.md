...
- [[10]]:[[10]] 剛結束為 ((696ee822-d457-4855-85e6-3af675512324)) 整理成 ((696ee84a-e4b6-4721-a7fb-1e71fe844ea6))，據我平時我在 [[Logseq]] 日誌的編輯習慣和格式 [[formatting]] ，添加到 [[Rovo Dev CLI]] 和 [[Antigravity]] 的[[全局規則配置]]如 [[GEMINI.md]]
	...
	- ### 規則層級體系
		- |優先級|文件|用途|適用範圍|
		  ...
		  |中等|`~/.rovodev/ROVODEV_RULES.md`|[[Claude]] 通用規則|所有使用 Claude 的工具|
		  |格式|`~/.rovodev/LOGSEQ_FORMATTING_RULES.md`|[[Logseq]] 格式化|輸出格式層|
		  |參考|`~/.gemini/GEMINI.md`| [[Gemini]] | [[Antigravity]] [[IDE]] |
	- ### 為什麼有 [[CLAUDE.md]]？
	- ```mermaid
	  flowchart TD
