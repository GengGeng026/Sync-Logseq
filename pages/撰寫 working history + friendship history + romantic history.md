...
- # Friendship History
	- Jian Li, male
		- 2005, we were from the same primary school, SJK(C) Chukai but studying in different class, the day I first told him my imaginary friend, a mouse that would talk to me , we started making friends with each other, but ended up we didn't talk anymore  since 2006 (even though) until several years later.
- # Working History
	- P/S:
