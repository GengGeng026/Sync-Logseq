...
- # Friendship History
	...
	- Johnathan, Male
		...
		- However, nearly close to end of 2022, no matter joint-venture collaboration with different parties and between only both of us, were forced to terminate due to conflict of interest statement amongst partners and personal accountability issues from Johnathan. Luckily, the core committees managed to execute prompt emergency crisis handling by
		-
- # Working History
	- P/S:
