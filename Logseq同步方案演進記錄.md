...
| 元素 | 顏色 | 說明 |
|:--------|:---------|:---------|
| <span style="color:#59B79A">◼</span> 初始階段 | 綠色 (#59B79A) | 表示最早的嘗試階段 |
| <span style="color:#C792EA">◼</span> 最終方案 | 紫色 (#C792EA) | 代表最終成功的解決方案 |
...
> **註**: 在時間軸中，初始階段特別用綠色 (#59B79A) 標記，最終方案用紫色 (#C792EA) 表示，以視覺區分演進過程。
> 
> **進階選項**: 若需要更精確控制每個階段的顏色，可考慮將此Mermaid圖表導出為圖片，然後使用圖像編輯工具（如GIMP、Photoshop）修改特定區域顏色後重新嵌入。
